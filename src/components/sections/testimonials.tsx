  ...
  return (
    <section className="bg-gray-50">
      <div className="mx-auto max-w-6xl 2xl:max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="mb-12">
          <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-black pb-4 text-center">Guest Reviews</div>
          <p className="text-gray-400 mb-6 text-center">What our guests say about their stay</p>
